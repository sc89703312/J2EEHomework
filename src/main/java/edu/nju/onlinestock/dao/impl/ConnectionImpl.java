 ...
 */
public class ConnectionImpl implements ConnectionHelper {

    private static ConnectionImpl connect = new ConnectionImpl();
    ...
    public static ConnectionImpl getConnectionInstance()
    {
        return connect;
    }
